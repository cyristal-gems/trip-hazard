...
**Trip Hazard** is a quirky arcade‑style endless runner that is best supported on **desktop devices**. Built using only HTML, CSS, JavaScript, and the Canvas API — no frameworks or installs, just open and play. 
